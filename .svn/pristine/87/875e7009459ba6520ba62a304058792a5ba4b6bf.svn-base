...
define(function (require, exports) {
    ...
    $('.save').click(function () {
    	...
    	//alert(UE.getEditor('note').getContent());
    	//return;
    	
    	
//    	alert(UE.getEditor('note').getPlainTxt() );
//    	return;
        ...
        if ($('[name="production"]').val() != 'line') {
        	...
        	var feature_content=UE.getEditor('feature').getContent()
				.replace(/\&lt;/g,"<").replace(/\&quot;/g,"\"").replace(/\&gt;/g,">")
				.replace(/\&nbsp;/g,"").replace(/\<p>/g,"").replace(/\<\/p>/g,"");
        	
        	
            $('[name="feature"]').val(feature_content);
            
            var note_content=UE.getEditor('note').getContent()
            					.replace(/\&lt;/g,"<").replace(/\&quot;/g,"\"").replace(/\&gt;/g,">")
            					.replace(/\&nbsp;/g,"").replace(/\<p>/g,"").replace(/\<\/p>/g,"");
            
            $('[name="note"]').val(note_content);
            
            
            //$('[name="note"]').val(UE.getEditor('note').getContentTxt());
        } else {
