define("seajs/seajs-text/1.0.3/seajs-text", [], function () {
    function a(a) {
        h[a.name] = a
    }
    ...
    a({name: "text", ext: [".tpl", ".html"], exec: function (a, b) {
        ...
        e(c)
    }}), a({name: "juicer", ext: [".juicer"], exec: function (a, b) {
        var c = ['define("' + a + '#", ["juicer"], function(require, exports, module) {', '  var source = "' + f(b) + '"', '  var juicer = require("juicer")', "  module.exports = function(data) {    return juicer(source).render(data)", "  }", "})"].join("\n");
        e(c)
